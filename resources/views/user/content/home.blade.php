...
<div class="slider-area ">
    <div class="slider-active">
        <div class="single-slider hero-overly slider-height d-flex align-items-center" data-background="@foreach ($home as $jumbo)
        {{ Storage::url($jumbo->img_title) }}
        @endforeach">
            <div class="container">
                <div class="row">
                    <div class="col-lg-11">
                        <div class="hero__caption">
                            ...
                            <div class="hero-text2 mt-110" data-animation="fadeInUp" data-delay=".9s">
                               <span><a href="{{ url('product') }}">Our Product</a></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-service-cap mb-30">
                    <div class="service-img">
                        <img src="{{ Storage::url($item->foto) }}" alt="" style="max-height: 230px">
                    </div>
...
<div class="container">
    ...
    <div class="d-none d-sm-block my-5 pb-4">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <form class="form-contact contact_form" action="{{ route('contactStore') }}" method="post" novalidate="novalidate">
                <div class="row">
                    <div class="col-12">
                        @csrf
